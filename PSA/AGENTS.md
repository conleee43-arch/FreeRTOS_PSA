...
This repository follows a shared living-docs style layout under `docs/`.
...
- Shared docs under `docs/` are the canonical project instructions.
- Do not copy shared rules back into this file.
